...
const TwoAttributePicker = (props: Props) => (
  <div className="mb-2  flex pb-1 flex-col">
    <div className="flex w-full items-center mb-5  border-b border-slate-400 pb-1">
      <select
        id="countries"
    ...
    <div className="flex w-full items-center  border-b border-slate-400 pb-1">
      ...
      <h1 className="ml-1 text-xs text-slate-300">
        {props.secondPropertiesSelected === "" ? "Choose The Weight Field" : props.secondPropertiesSelected}
      </h1>
    </div>
  </div>
);
